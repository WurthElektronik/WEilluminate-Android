...
public class ProfileListFragment extends Fragment {
    ...
    public boolean isTextNoProfilesVisible() {
        return tvNoProfiles.getVisibility() == View.VISIBLE;
    }

    public void hideTextNoProfiles() {
        this.tvNoProfiles.setVisibility(View.GONE);
    }
}
