    ...
    public void onBindViewHolder(@NonNull DeviceHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener((View v) -> {
            if(listItem.getDeviceAddress().equals(ScanFragment.DEMO_ADDRESS)) {
                scanFragment.connectDemoDevice(listItem);
            } else {
        ...
        holder.imgFav.setOnClickListener((View v) -> {
            if(!ScanFragment.getFragment().isDeviceFavourite(listItem)) {
        ...
        if(ScanFragment.getFragment().isDeviceFavourite(listItem)) {
            holder.imgFav.setEnabled(true);
            holder.imgFav.setImageResource(R.drawable.ic_star);
        } else if (listItem.getDeviceAddress().equals(ScanFragment.DEMO_ADDRESS)) {
            holder.imgFav.setEnabled(false);
            holder.imgFav.setImageResource(R.drawable.ic_star_border_transparent);
        } else  {
            holder.imgFav.setEnabled(true);
            holder.imgFav.setImageResource(R.drawable.ic_star_border);
        }
