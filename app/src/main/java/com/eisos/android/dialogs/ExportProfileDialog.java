...
import com.eisos.android.profiles.JSONBuilder;
import com.eisos.android.profiles.ProfileListFragment;
...
public class ExportProfileDialog extends DialogFragment {
    ...
    public static final String FILE_PATH = "Download/WEilluminate/";
